...
export async function POST(request: Request, context: { params: Promise<{ operation: string }> }) {
  ...
  try {
    ...
    if (!input || typeof input !== "object" || Array.isArray(input) || "serverSecret" in input)
    ...
    switch (operation) {
      case "list":
        result = (await client.query(api.recipes.list, args)).map(localPhoto);
        break;
      case "get": {
      ...
      case "listTags":
        result = await client.query(api.recipes.listTags, args);
        break;
      case "create":
        result = await client.mutation(api.recipes.create, args);
        break;
      case "update":
        result = await client.mutation(api.recipes.update, args);
        break;
      case "markCooked":
        result = await client.mutation(api.recipes.markCooked, args);
        break;
      case "remove":
        result = await client.mutation(api.recipes.remove, args);
        break;
      default:
