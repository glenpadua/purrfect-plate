...
export function ErrorBoundary({ retry }: ErrorBoundaryProps) {
  return (
    <Page>
      ...
      <Body>The library could not load. Check your connection, then retry.</Body>
    ...
    return (
      <SafeAreaProvider>
        <Page>
          ...
          <Body>
            Configure the public Clerk key and Convex URL in apps/mobile/.env.local, then restart
            Expo.
          </Body>
        </Page>
      </SafeAreaProvider>
          ...
          <AuthGate>
            <ProductShell>
              ...
              >
                ...
                <Stack.Screen name="edit" options={{ title: "Recipe editor" }} />
