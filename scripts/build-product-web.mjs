...
if (!convexUrl || !clerkKey)
  throw new Error("The web build requires the public Convex URL and Clerk key.");
if (
  process.env.VERCEL_ENV === "production" &&
  new URL(convexUrl).hostname !== "spotted-gazelle-950.convex.cloud"
) {
...
writeFileSync(
  ...
  readFileSync(indexPath, "utf8").replace(
    "<title>Purrfect Plate Dev</title>",
    "<title>Purrfect Plate</title>",
  ),
);
