# Historical mobile planning and implementation log

This is an archived record of successive checkpoints. Many setup, duplicate-UI and release statements below were superseded. Use [the current mobile record](../mobile-plan.md), [README](../../README.md) and [architecture guide](../how-the-app-works.md) for current instructions.
