...
function AlertDialogTitle({
  ...
  return (
    <AlertDialogPrimitive.Title
      ...
      className={cn(
        "text-sm font-medium sm:group-has-data-[slot=alert-dialog-media]/alert-dialog-content:group-data-[size=default]/alert-dialog-content:col-start-2",
        className
      )}
      {...props}
    />
...
function AlertDialogDescription({
  ...
  return (
    <AlertDialogPrimitive.Description
      ...
      className={cn(
        "text-muted-foreground hover:[a]:*:text-foreground text-xs/relaxed text-balance md:text-pretty [a]:*:underline [a]:*:underline-offset-3",
        className
      )}
      {...props}
    />
